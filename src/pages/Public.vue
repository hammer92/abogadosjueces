      ...
      <div class="inner">
        ...
        <section id="banner">
          <div class="botones-menu">
            <button class="btn-yellow">Afiliate</button>
          </div>
          <div>
            <span class="image object">
              <img src="/images/logo-jueces.png" alt="" style="height: 130px" />
            </span>
          </div>
          <div class="somos-imagen">
            <div>
              <p class="somos">Somos</p>
              <p class="title">PROFESIONALES A SU SERVICIO</p>
              <p class="lema">
                Nuestros servicios se extienden en la ciudades principales como:
                Bogotá, Cali, Medellin, Bucaramanga y Pasto
              </p>
            </div>
            <img src="images/mesa-abogados.jpg" alt="" />
          </div>
          <div class="linea">
            <img
              src="images/linea naranja.webp"
              alt=""
        ...
        <form id="ajaxForm" v-on:submit.prevent="onSubmit()">
          <img src="images/apreton-manos.jpg" alt="" />
          <div class="form-inputs">
            ...
            <div class="">
              ...
              <div class="col-50">
                ...
                <input type="text" v-model="model.CIUDAD" />
              </div>
              ...
              <div class="col-100">
                ...
                <input type="text" v-model="model.EMPRESA" />
              </div>
        ...
        <section id="contacto">
          <div class="content">
            <p class="title">CONTANTO</p>
            <p class="subtitle">Torre Colseguros Oficina 1103 - Centro</p>
            <p class="subtitle">juescesltda@gmail.com</p>
            <p class="subtitle">(6)07 670 1202</p>
          </div>
...
#planes .section-planes .card-planes {
  width: 40%;
  border-radius: 20px;
  font-size: 30px;
  font-weight: bold;
...
.card-planes .contenido {
  font-size: 18px;
}
.line {
  width: 70%;
  margin: auto;
  border-top: 4px solid #cb9c00;
}
...
#ajaxForm .form-inputs {
  color: #000;
  font-weight: bold;
  width: 45%;
}
#ajaxForm .form-inputs .content-inputs {
  margin-top: 30px;
  display: flex;
...
.content-inputs .col-100 {
  width: 100%;
  float: left;
  margin-top: 10px;
}
#ajaxForm .form-inputs .title {
  font-size: 50px;
  color: #cb9c00;
}
#ajaxForm .form-inputs .subtitle {
  font-size: 20px;
}
#ajaxForm .form-inputs label {
  font-size: 16px;
  color: #000;
  margin: 0;
}
